package com.rupeshs.travel.packages.images.web;
...
import com.rupeshs.travel.packages.images.business.ImageService;
...
@RestController
@Slf4j
@Tag(name = "Hosting of Images", description = "Upload and fetch Images for the Explore Travel Packages website")
